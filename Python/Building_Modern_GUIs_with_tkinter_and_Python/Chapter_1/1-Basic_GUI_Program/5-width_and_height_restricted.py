...
myroot = tkinter.Tk() # create variable myroot and assign it to be a default object of the Tk class

myroot.resizable(width = False, height = False) # width is adjustable, but height is not 
